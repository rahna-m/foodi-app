...
import 'package:foodii_riders_app/mainScreens/order_details_screen.dart';
import 'package:foodii_riders_app/models/items.dart';
...
class OrderCard extends StatelessWidget {
  ...
  OrderCard(
      {this.itemCount, this.data, this.orderID, this.seperateQuantitiesList});
